...
ui <- navbarPage(title = "PrIntMap-R",
                 ...
                 tabPanel("Run",
                          flowLayout(
                            ...
                            selectInput(inputId = "file_type",
                                         ...
                                         choices = c("PEAKS", "DIA-NN", "MSFragger", "MaxQuant", "MetaMorpheus", "Proteome Discoverer", "Generic csv"),
                                         selected = "PEAKS"),
                                     ...
                                     br(),
                                       bsCollapse(
                                         bsCollapsePanel("2nd Sample Input (Click Here)", style = "primary",
                                                         flowLayout(
                                                         selectInput(inputId = "file_type2",
                                                                              label = "2nd Search Software",
                                                                              choices = c("PEAKS","DIA-NN", "MSFragger", "MaxQuant", "MetaMorpheus", "Proteome Discoverer", "Generic csv"),
                                                                              selected = "PEAKS"),
                                                         fileInput(inputId = "peptide_file2", label = "Upload 2nd peptide output",
                                                                   accept = c(".csv", ".tsv", ".txt", ".psmtsv")),
                                                         tipify(textInput(inputId = "sample_name2", 
                                                                          label = "Input 2nd sample display name",
                 ...
                 tabPanel("Examples",
                          ...
                          tags$h4("The following can be filled out and used for custom data analysis. Any numbers can go in the intensity column for versatility."),
